  ...
  class ParamEncodingTest2Api
    ...
    def test_param_encoding_ok(
      *,
      ...
      test_param_encoding_ok_with_http_info(param_encoding_test2_request_body: param_encoding_test2_request_body, array_in_query: array_in_query, map_in_query: map_in_query, tag_in_query: tag_in_query)
      nil
    end
    ...
    def test_param_encoding_ok_with_http_info(
      *,
      param_encoding_test2_request_body : PetStore::ParamEncodingTest2RequestBody? = nil,
      array_in_query : Array(String)? = nil,
      map_in_query : JSON::Any? = nil,
      ...
      request = build_api_request_for_test_param_encoding_ok(param_encoding_test2_request_body: param_encoding_test2_request_body, array_in_query: array_in_query, map_in_query: map_in_query, tag_in_query: tag_in_query)

      body, status_code, headers = @api_client.execute_api_request(request)

      if debugging
        Log.debug { "API called: ParamEncodingTest2Api#test_param_encoding_ok\nBody: #{body.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}" }
      end
    ...
    def test_param_encoding_ok(
      *,
      ...
      build_api_request_for_test_param_encoding_ok(param_encoding_test2_request_body: param_encoding_test2_request_body, array_in_query: array_in_query, map_in_query: map_in_query, tag_in_query: tag_in_query).execute(&block)
    end

    # @return Crest::Request
    def build_api_request_for_test_param_encoding_ok(
      *,
      param_encoding_test2_request_body : PetStore::ParamEncodingTest2RequestBody? = nil,
      array_in_query : Array(String)? = nil,
      map_in_query : JSON::Any? = nil,
      ...
      if debugging
        Log.debug { "Calling API: ParamEncodingTest2Api.test_param_encoding_ok ..." }
      end
      ...
      # resource path
      local_var_path = "/param_encoding_test2"
      ...
      @api_client.build_api_request(
        http_method: :"POST",
        path: local_var_path,
        operation: "ParamEncodingTest2Api.test_param_encoding_ok",
        post_body: post_body,
